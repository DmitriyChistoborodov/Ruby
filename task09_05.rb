...
puts 'Пожалуйста, введите имя дракончику'

pet = Dragon.new gets.chomp

puts 'Введите действия, которые вы хотите произвести над дракочиком'
...
while(command!='exit')
    ...
    if(command=='help')
        puts '  feed - кормить дракончика'
        puts '  walk - выгуливать дракончика'
        puts '  toss - подбрасывать'
        puts '  rock - укачивать'
